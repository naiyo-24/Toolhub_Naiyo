...
void _folderSerialize(
  ...
  writer.writeString(offsets[3], object.parentFolderId);
}
...
Folder _folderDeserialize(
  ...
  object.parentFolderId = reader.readStringOrNull(offsets[3]);
  return object;
}
...
extension FolderQueryFilter on QueryBuilder<Folder, Folder, QFilterCondition> {
  ...
  QueryBuilder<Folder, Folder, QAfterFilterCondition> parentFolderIdStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Folder, Folder, QAfterFilterCondition> parentFolderIdEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Folder, Folder, QAfterFilterCondition> parentFolderIdContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Folder, Folder, QAfterFilterCondition> parentFolderIdMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Folder, Folder, QAfterFilterCondition> parentFolderIdIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'parentFolderId',
        value: '',
...
extension FolderQueryProperty on QueryBuilder<Folder, Folder, QQueryProperty> {
  ...
  QueryBuilder<Folder, String?, QQueryOperations> parentFolderIdProperty() {
    return QueryBuilder.apply(this, (query) {
