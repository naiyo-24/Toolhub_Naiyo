...
class SocialToolScreen extends StatefulWidget {
  final Map<String, dynamic> tool;

  const SocialToolScreen({super.key, required this.tool});

  @override
  State<SocialToolScreen> createState() => _SocialToolScreenState();
}

class _SocialToolScreenState extends State<SocialToolScreen> {
  ...
  Future<void> _calculate() async {
    ...
    for (var entry in _controllers.entries) {
      ...
      if (value.toLowerCase() == 'true') {
        ...
        data[entry.key] = int.tryParse(value) ?? 15;
      } else {
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ...(entry['results'] as Map<String, dynamic>).entries.map((e) => 
                      SelectableText('${_formatKey(e.key)}: ${e.value}', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: color))
                    ),
                  ],
                ),
              ),
            ...
            const NeoCard(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8),
                  Text(
                    "1. Fill in the required text or fields.\n2. Tap the action button at the bottom.\n3. Copy or view your result below.",
              ...
              ...config.map((field) {
                ...
                return Padding(
                  ...
                  child: TextField(
                    ...
                    keyboardType: field['key'] == 'count' ? TextInputType.number : TextInputType.multiline,
                    decoration: InputDecoration(
                      labelText: field['label'],
