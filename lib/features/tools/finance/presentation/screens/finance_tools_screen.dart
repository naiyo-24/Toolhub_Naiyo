        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text('Finance Tools', style: AppTextStyles.heroTitle.copyWith(fontSize: 28)),
                const Text('Smart financial calculators', style: TextStyle(color: Colors.grey, fontSize: 14)),
              ],
            ),
          ),
        ],
