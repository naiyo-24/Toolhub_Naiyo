...
class ImageCompressorScreen extends ConsumerStatefulWidget {
  const ImageCompressorScreen({super.key});

  @override
  ConsumerState<ImageCompressorScreen> createState() => _ImageCompressorScreenState();
}

class _ImageCompressorScreenState extends ConsumerState<ImageCompressorScreen> {
  ...
  Future<void> _executeAction() async {
    ...
    try {
      ...
      final bytes = await service.compressImage(
        xfile, 
        _quality.toInt(), 
      ...
      if (newSize >= originalSize) {
        resultText = 'Notice: This Image is already highly optimized and could not be compressed further without losing data.\nOriginal: ${formatSize(originalSize)}\nNew: ${formatSize(newSize)}';
      } else {
  ...
  void _shareFile() {
    ...
    Share.shareXFiles([XFile(_savedFilePath!)], text: 'Here is the compressed image!');
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Compress Image', style: AppTextStyles.heroTitle.copyWith(fontSize: 20, color: Colors.white)),
        ...
        child: Column(
          children: [
            NeoCard(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("1. Pick an Image.\n2. Choose 'Quality Slider' or 'Target Size'.\n3. Tap 'Compress Image' to reduce file size.", style: AppTextStyles.bodyText.copyWith(fontSize: 14)),
                ],
              ),
            ),
            ...
            child: Column(
              ...
              children: [
                const Icon(Icons.image_rounded, size: 64, color: AppColors.primaryPink),
                const SizedBox(height: 16),
                Text('Compress Image Size', style: AppTextStyles.heroTitle.copyWith(fontSize: 20)),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    label: Builder(
                      builder: (context) {
                        if (_selectedFiles.isEmpty) return const Text('Select Image', style: TextStyle(color: Colors.black, fontSize: 16, fontWeight: FontWeight.bold));
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: _isLoading 
                      ...
                      : Text('Compress Image', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: _selectedFiles.isEmpty ? Colors.grey[500] : Colors.white)),
                  ),
                ),
